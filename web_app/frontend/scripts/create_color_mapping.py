...
COLOR_CODE_MAP = {
    ...
    "BLACK_GD": "Black, GD",
    "WHITE_GD": "White, GD",
    "LIGHTBLUE_GD": "Light Blue, GD",
    "CHARCOAL_GD": "Charcoal, GD",
    "NAVY_GD": "Navy, GD",
    "RED_GD": "Red, GD",
    "SPORTGREY_GD": "Sport Grey, GD",
    "MAROON_GD": "Maroon, GD",
    "DARKHEATHER_GD": "Dark Heather, GD",
    "ROYALBLUE_GD": "Royal Blue, GD",
    "LIGHTPINK_GD": "Light Pink, GD",
    "SAND_GD": "Sand, GD",
    "FORESTGREEN_GD": "Forest Green, GD",
    "ASHGREY_GD": "Ash Grey, GD",
    "PURPLE_GD": "Purple, GD",
    "MILITARYGREEN_GD": "Military Green, GD",
    "ORANGE_GD": "Orange, GD",
    "ANTIQUECHERRYRED_GD": "Antique Cherry Red, GD",
    "ANTIQUEIRISHGREEN_GD": "Antique Irish Green, GD",
    "ANTIQUEJADEDOME_GD": "Antique Jade Dome, GD",
    "ANTIQUEORANGE_GD": "Antique Orange, GD",
    "AQUATIC_GD": "Aquatic, GD",
    "AZALEA_GD": "Azalea, GD",
    "BERRY_GD": "Berry, GD",
    "BROWNSAVANA_GD": "Brown Savana, GD",
    "CARDINALRED_GD": "Cardinal Red, GD",
    "CAROLINABLUE_GD": "Carolina Blue, GD",
    "COBALT_GD": "Cobalt, GD",
    "DAISY_GD": "Daisy, GD",
    "DARKCHOCOLATE_GD": "Dark Chocolate, GD",
    "DUSTYROSE_GD": "Dusty Rose, GD",
    "ELECTRICGREEN_GD": "Electric Green, GD",
    "GARNET_GD": "Garnet, GD",
    "GOLD_GD": "Gold, GD",
    "GRAPHITEHEATHER_GD": "Graphite Heather, GD",
    "GRAVEL_GD": "Gravel, GD",
    "HEATHERMILITARYGREEN_GD": "Heather Military Green, GD",
    "HEATHERNAVY_GD": "Heather Navy, GD",
    "HEATHERRADIANTORCHID_GD": "Heather Radiant Orchid, GD",
    "HELICONIA_GD": "Heliconia, GD",
    "ICEGREY_GD": "Ice Grey, GD",
    "INDIGOBLUE_GD": "Indigo Blue, GD",
    "IRISHGREEN_GD": "Irish Green, GD",
    "KIWI_GD": "Kiwi, GD",
    "LILAC_GD": "Lilac, GD",
    "LIME_GD": "Lime, GD",
    "MINTGREEN_GD": "Mint Green, GD",
    "NATURAL_GD": "Natural, GD",
    "NEONBLUE_GD": "Neon Blue, GD",
    "OFFWHITE_GD": "Off White, GD",
    "SORANGE_GD": "Sorange, GD",
    "SAFETYPINK_GD": "Safety Pink, GD",
    "SAPPHIRE_GD": "Sapphire, GD",
    "SKY_GD": "Sky, GD",
    "SUNSET_GD": "Sunset, GD",
    "TANGERINE_GD": "Tangerine, GD",
    "TENNESSEEORANGE_GD": "Tennessee Orange, GD",
    "TORANGE_GD": "Torange, GD",
    "TROPICALBLUE_GD": "Tropical Blue, GD",
    "TURFGREEN_GD": "Turf Green, GD",
    "TWEED_GD": "Tweed, GD",
    "VIOLET_GD": "Violet, GD",
    "YELLOWHAZE_GD": "Yellow Haze, GD"
}
        ...
        if brand in style_to_extract:
            if color not in color_mapping:
                if '_GD' in color:
                    ...
                    color_mapping[f'{color_name}'] = f'{color_split[0].capitalize()}, {color_split[1]}'
                else:
